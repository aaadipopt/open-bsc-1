...
pub fn verify_block_final(expected: &Header, got: &Header) -> Result<(), Error> {
    if expected.state_root() != got.state_root() {
        ...
        info!(target: "expected.state_root", " #{} ({})\n ========== state_root: ", expected.state_root(), got.state_root());
    ...
    if expected.gas_used() != got.gas_used() {
        ...
        info!(target: "expected.gas_used", " #{} ({})\n ========== gas_used: ", expected.gas_used(), got.gas_used());
    ...
    if expected.log_bloom() != got.log_bloom() {
        info!(target: "expected.log_bloom", " #{} ({})\n ========== log_bloom: ", expected.log_bloom(), got.log_bloom());
    ...
    if expected.receipts_root() != got.receipts_root() {
        info!(target: "expected.receipts_root", " #{} ({})\n ========== receipts_root: ", expected.receipts_root(), got.receipts_root());
